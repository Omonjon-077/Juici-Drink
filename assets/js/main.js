...
TweenMax.from('.home__description', 1, {delay: .4, opacity: 0, y: 20, ease: Expo.easeInOut});
TweenMax.from('.home__button', 1, {delay: .6, opacity: 0, y: 20, ease: Expo.easeInOut});
TweenMax.from('.home__liquid', 1, {delay: .9, opacity: 0, y: 200, ease: Expo.easeInOut});
